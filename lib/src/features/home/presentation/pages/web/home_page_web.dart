...
class _HomePageWebState extends State<HomePageWeb> {
  ...
  Widget build(BuildContext context) {
    ...
    List<HoverImageCardEntity> hoverImageCardEntity = [
      ...
      HoverImageCardEntity(title: locale.contains('en') ? 'Mashhad' : 'مشهد', date: locale.contains('en') ? '11 Jul 2024 - 17 Jul 2024' : '1 مرداد 1403 - 5 مرداد 1403', price: locale.contains('en') ? 'Economy from Tehran 1,280,000 IRR' : 'اکونومی از تهران 1,280,000 ریال', imageUrl: ImageManager.mashhad, isHover: false),
      ...
      HoverImageCardEntity(title: locale.contains('en') ? 'Isfahan' : 'اصفهان', date: locale.contains('en') ? '29 Aug 2024 - 03 Sep 2024' : '4 مرداد 1403 - 8 مرداد 1403', price: locale.contains('en') ? 'Economy from Tehran 1,300,000 IRR' : 'اکونومی از تهران 1,300,000 ریال', imageUrl: ImageManager.isfahan, isHover: false),
    ];
    return Scaffold(
      key: scaffoldKey,
